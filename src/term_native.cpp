// Hand-written implementation of the terminal manipulators declared in
// <collab/term.hpp>. rang handles NO_COLOR, TTY detection, and the Windows
// console path internally — it's a private link dependency of the static
// collab library.
